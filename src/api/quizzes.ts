...
export const getNextPublishDate = async (): Promise<NextPublishDateData> => {
  const response = await quizServiceClient.get<
    BaseResponse<NextPublishDateData>
...
export const getQuizDetail = async (
  params: ParentsQuizDetailPathParam
): Promise<ParentsQuizDetailResponseData> => {
  const { quizId } = params;
  const response = await quizServiceClient.get<
    BaseResponse<ParentsQuizDetailResponseData>
  >(`/api/quiz/${quizId}`);
...
export const updateQuiz = async (
  params: UpdateQuizPathParam,
  data: UpdateQuizRequestDto
): Promise<UpdateQuizResponseData> => {
  const { quizId } = params;
  const response = await quizServiceClient.patch<
    BaseResponse<UpdateQuizResponseData>
...
export const deleteQuiz = async (
  params: DeleteQuizPathParam
): Promise<DeleteQuizResponseData> => {
  const { quizId } = params;
  const response = await quizServiceClient.delete<
    BaseResponse<DeleteQuizResponseData>
  >(`/api/quiz/${quizId}`);
...
export const grantQuizReward = async (
  params: ParentsGrantRewardPathParam,
  data: ParentsGrantRewardRequestDto
): Promise<ParentsGrantRewardResponseData> => {
  const { quizId, childProfileId } = params;
  const response = await quizServiceClient.patch<
    BaseResponse<ParentsGrantRewardResponseData>
...
export const getChildCompletedQuizzes = async (
  ...
  const response = await quizServiceClient.get<
    BaseResponse<ChildrenCompletedResponseData>
...
export const answerQuiz = async (
  params: AnswerQuizPathParam,
  data: AnswerQuizRequestDto
