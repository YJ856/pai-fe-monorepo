...
export default function ParentQuizScreen() {
  ...
  const { todayQuizzes: todayQuizzesData, isLoading: isLoadingTodayQuizzes } =
    useTodayQuizzes();

  const { pastQuizzes: pastQuizzesData, isLoading: isLoadingPastQuizzes } =
    usePastQuizzes();
              ...
              {solutions.map((solution) => (
                <View
                  ...
                  style={[
                    styles.solutionCard,
                    solution.solved
                      ? styles.solutionCardSolved
                      : styles.solutionCardPending,
                  ]}
                >
                  <View style={styles.solutionInfo}>
                    ...
                    <Text style={styles.solutionName}>
                      {solution.childName}
                    </Text>
                  </View>
                  {solution.solved ? (
        ...
        {showActions && quiz.isEditable && (
          <View style={styles.actionsContainer}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              onPress={() => {
                Alert.alert("퀴즈 삭제", "정말 이 퀴즈를 삭제하시겠습니까?", [
                    ...
                    >
                      <View style={styles.modalSolutionHeader}>
                        <View style={styles.modalSolutionInfo}>
                          <Text style={styles.modalSolutionName}>
                            {solution.childName}
                          </Text>
                        </View>
                        {solution.solved ? (
                      ...
                      {solution.solved && selectedQuiz.reward && (
                        <Button
                          ...
                          onPress={() =>
                            handleGrantReward(selectedQuiz.id, solution.childId)
                          }
                          disabled={solution.rewardGiven || isGranting}
                          style={{
                            ...styles.rewardButton,
                            ...(!solution.rewardGiven && {
                        ...
                        >
                          <View style={styles.rewardButtonContent}>
                            <Gift
                              size={16}
                              color={
                                solution.rewardGiven ? "#6B7280" : "#FFFFFF"
                              }
                            />
                            <Text
                              style={[
